<?php
class Kerss_Sizechart_Block_Adminhtml_Sizechart_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
		public function __construct()
		{
				...
				$this->setTitle(Mage::helper("sizechart")->__("Item Information"));
		}
