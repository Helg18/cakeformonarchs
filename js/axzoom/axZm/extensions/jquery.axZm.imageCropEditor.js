	...
	addCropDescrTable = function(img, num){
		...
		<tbody><tr>\
			<td style="vertical-align: top; width: 110px; padding-top: 10px;">\
				<img src="'+img+'" style="max-width: 100px; min-width: 100px; height: auto; border: 2px groove #FFF; cursor: pointer;" onclick="$(\'li[data-cropnum='+num+']\', $(\'#cropSlider\')).trigger(\'click\'); $(window).scrollTo(0)">\
