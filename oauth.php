...
function getOauthAccessKeyAndSecret($oauthConsumerKey,$oauthConsumerSecret,$username,$password,$baseurl){
	...
	echo $realm."<br>";
	echo $endpointUrl."<br>";
	echo $oauthCallback."<br>";
	echo $oauthNonce."<br>";
	echo $oauthSignatureMethod."<br>";
	echo $oauthTimestamp."<br>";
	echo $oauthVersion."<br>";
	echo $oauthMethod."<br>";
	echo $oauthConsumerKey ."<br>";
	echo $oauthConsumerSecret."<br>";
	...
	echo "Encoded data: ". urlencode($encodedData) . "<br>";
	echo "key: ". $key . "<br>";
	echo "signature: ". $signature . "<br>";
	echo "oauthSignature: ". $oauthSignature . "<br>";
...
getOauthAccessKeyAndSecret('c301fb7af2d3d3c0912bd92eeaf4a22f','bd15a36b903118478aeff829d027f34a','gp.rafaelc@gmail.com','admin123*','http://zierconsulting.com/cakeformonarchs/');
